...
def write_latest_metrics(apps: list[base.AppDigest], report_date: str) -> None:
    ...
    payload = {
        ...
        "apps": summaries,
        "analysis_instruction": "Produire une reflexion strategique longue seulement si les donnees le justifient: utiliser les valeurs primaires filtrees sur report_date pour tout diagnostic quotidien et toute comparaison; les champs *_total_available servent uniquement a l'audit de collecte. Lire freshness/report_date, history J-7/J-30, funnel_by_source, funnel_by_territory, sales/pricing, reviews, metadata, screenshot_inventory et quality_signals. Distinguer signal reel, bruit probable, hypothese et donnee manquante. Avant toute recommandation produit, pricing, ASO, screenshots ou metadata, verifier app.review_pipeline: si has_blocking_pipeline_change vaut true ou si une version est READY_FOR_REVIEW, WAITING_FOR_REVIEW, IN_REVIEW, PENDING_APPLE_RELEASE, PENDING_DEVELOPER_RELEASE, PROCESSING_FOR_APP_STORE ou WAITING_FOR_EXPORT_COMPLIANCE, traiter ces changements comme deja engages et proposer uniquement des actions compatibles.",
    }
