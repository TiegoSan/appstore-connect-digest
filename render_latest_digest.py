...
def app_digest_from_summary(item: dict[str, Any]) -> digest.AppDigest:
    data = {
        ...
        "downloads_total_available": item.get("downloads_total_available") or 0,
        "first_time_downloads_total_available": item.get("first_time_downloads_total_available") or 0,
        "impressions_total_available": item.get("impressions_total_available") or 0,
        "unique_impressions_total_available": item.get("unique_impressions_total_available") or 0,
        "product_page_views_total_available": item.get("product_page_views_total_available") or 0,
        "unique_product_page_views_total_available": item.get("unique_product_page_views_total_available") or 0,
        "taps_total_available": item.get("taps_total_available") or 0,
        "unique_taps_total_available": item.get("unique_taps_total_available") or 0,
        "conversion_rate_total_available": item.get("conversion_rate_total_available"),
        "page_view_rate_total_available": item.get("page_view_rate_total_available"),
        "tap_rate_total_available": item.get("tap_rate_total_available"),
